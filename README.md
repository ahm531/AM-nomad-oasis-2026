![docker image](https://github.com/ahm531/AM-nomad-oasis-2026/actions/workflows/docker-publish.yml/badge.svg)
...
2. Clone the repository or download the repository as a zip file.
    ...
    ```sh
    git clone https://github.com/ahm531/AM-nomad-oasis-2026.git
    cd AM-nomad-oasis-2026
    ```

    or

    ```sh
    curl -L -o AM-nomad-oasis-2026.zip "https://github.com/ahm531/AM-nomad-oasis-2026/archive/main.zip"
    unzip AM-nomad-oasis-2026.zip
    cd AM-nomad-oasis-2026
    ```
...
your `docker-compose.yaml` with `ghcr.io/ahm531/am-nomad-oasis-2026:main` for the services
...
```sh
docker pull ghcr.io/ahm531/am-nomad-oasis-2026/jupyter:main
```
...
- _I get an_ `Error response from daemon: Head "https://ghcr.io/v2/ahm531/am-nomad-oasis-2026/manifests/main": unauthorized` _when trying to pull my docker image._
